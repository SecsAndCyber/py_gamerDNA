...
class gamerDNA(object):
    ...
    def SetBio( self, **kwargs):
        data_block = "&".join ([
            ...
            "user_profile[firstname]=%s" %                      ( urllib2.quote(kwargs.get('firstname',"Super First Name"))),
            "user_profile[lastname]=%s" %                       ( urllib2.quote(kwargs.get('lastname',"Mega Last Name"))),
            "user_profile[privacy_show_name]=%s" %              ( urllib2.quote(kwargs.get('privacy_show_name',"1"))),
            "dob_month=%s" %                                    ( urllib2.quote(kwargs.get('dob_month',"2"))),
            "dob_day=%s" %                                      ( urllib2.quote(kwargs.get('dob_day',"2"))),
            "dob_year=%s" %                                     ( urllib2.quote(kwargs.get('dob_year',"1957"))),
            "user_profile[privacy_show_age]=%s" %               ( urllib2.quote(kwargs.get('show_age',"1"))),
            "gender=%s" %                                       ( urllib2.quote(kwargs.get('gender',"1"))),
            ...
            "user_profile[preferred_genre_id]=%s" %             ( kwargs.get('genre_id',"D+++++++20")),
